...
int Sound::create_source(bool loop, bool global)
{
	ALuint hSource;
	ALenum		al_err;
...
void Sound::source_position(int hSource, float *position)
{
	alSourcefv(hSource, AL_POSITION, position);
}

void Sound::source_velocity(int hSource, float *velocity)
{
	alSourcefv(hSource, AL_VELOCITY, velocity);
}

void Sound::listener_position(float *position)
{
	alListenerfv(AL_POSITION, position);
}

void Sound::listener_velocity(float *velocity)
{
	alListenerfv(AL_VELOCITY, velocity);
}

void Sound::listener_orientation(float *orientation)
{
	alListenerfv(AL_ORIENTATION, orientation);
}

void Sound::delete_source(int hSource)
{
	ALenum		al_err;
...
void Sound::select_buffer(int hSource, int hBuffer)
{
	ALenum		al_err;
...
void Sound::delete_buffer(int hBuffer)
{
	ALenum		al_err;
...
void Sound::play(int hSource)
{
	alSourcePlay(hSource);
}

void Sound::stop(int hSource)
{
