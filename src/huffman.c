// Was writing my own huffman coding implementation, but this one seems pretty good
// Usage: huffman_encode_memory(buf, cur, &bufout, &bufoutlen)
//        huffman_decode_memory(buf, cur, &bufout, &bufoutlen)
