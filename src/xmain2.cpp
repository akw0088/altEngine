...
//	int data[2048*2048] = {~0};
//	int screen = DefaultScreen(display);
//	GC gc = DefaultGC(display, screen);
//	int depth = DefaultDepth(display, screen);
//	Pixmap bitmap = XCreatePixmap(display, DefaultRootWindow(display), width, height, depth);

//XCopyPlane(display, bitmap, window, gc, 0, 0, width, height, 0, 0, 1);
//	XImage *ximage = XCreateImage(display, vinfo->visual, 32, XYBitmap, 0, (char *)data, width, height, 0, depth);
//	XPutImage(display, DefaultRootWindow(display), gc, ximage, 0, 0, 0, 0, width, height);
