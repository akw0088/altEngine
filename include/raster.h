...
void raster_triangles(raster_t type, int block, int *pixels, float *zbuffer, int width, int height, matrix4 &mvp, int *index_array, vertex_t *vertex_array, texinfo_t *texture_array, int start_index, int start_vertex, int num_index, int num_verts);
void raster_triangles_strip(raster_t type, int block, int *pixels, float *zbuffer, int width, int height, matrix4 &mvp, int *index_array, vertex_t *vertex_array, texinfo_t *texture_array, int start_index, int start_vertex, int num_index, int num_verts);
